...
export default function ViewBill() {
  ...
  if (!bill) return <p className="text-gray-500 text-center">Loading your bill...</p>;
  ...
  return (
    <div className="bg-white shadow-md rounded-xl p-6 w-full max-w-md mx-auto mt-6">
      ...
      <ul className="space-y-2 text-gray-700">
        ...
        <li className="font-bold text-lg mt-2"><strong>Total Bill:</strong> ₹{bill.total_bill?.toFixed(2) ?? "0.00"}</li>
      </ul>
    </div>
  );
}
